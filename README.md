...
| `PULSE_LICENSE_PUBLIC_KEY` | Self-hosted image build | RSA public PEM via `--build-arg` when building `chideraozigbo488/entivia` (baked into `/etc/pulse/build-config.json`; customers do not set this) |
